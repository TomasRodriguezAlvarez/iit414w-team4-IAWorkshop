...
| **Scenario inputs** | `n_stops`, `strategy_type`, `compound_sequence`, `stint_lengths`, `stint1_length`–`stint5_length` | ⚠️ What-if labels only — never in the predictive pipeline |
